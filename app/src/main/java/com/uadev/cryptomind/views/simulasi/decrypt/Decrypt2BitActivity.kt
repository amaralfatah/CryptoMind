...
class Decrypt2BitActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDecrypt2BitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDecrypt2BitBinding.inflate(layoutInflater)
    ...
    private fun updateTutorialStep(step: Int) {
        val contentPath = when (step) {
            1 -> "cfb2/decrypt/cfb2_intro.png"
            2 -> "cfb2/decrypt/cfb2_step1.mp4"
            3 -> "cfb2/decrypt/cfb2_step2.mp4"
            4 -> "cfb2/decrypt/cfb2_step3.mp4"
            5 -> "cfb2/decrypt/cfb2_step4.mp4"
            6 -> "cfb2/decrypt/cfb2_step5.mp4"
            7 -> "cfb2/decrypt/cfb2_step6.mp4"
            8 -> "cfb2/decrypt/cfb2_step7.mp4"
            9 -> "cfb2/decrypt/cfb2_step8.mp4"
            10 -> "cfb2/decrypt/cfb2_step9.mp4"
            11 -> "cfb2/decrypt/cfb2_step10.mp4"
            12 -> "cfb2/decrypt/cfb2_step11.mp4"
            13 -> "cfb2/decrypt/cfb2_step12.mp4"
            14 -> "cfb2/decrypt/cfb2_step13.mp4"
            15 -> "cfb2/decrypt/cfb2_outro.png"
            else -> "cfb2/decrypt/cfb2_intro.png"
        }
...
//                    binding.playPauseButton.setTextColor(ContextCompat.getColor(this, R.color.white))
            ...
            // Tangani kegagalan
            Log.e("Decrypt2BitActivity", "Error getting download URL", exception)
